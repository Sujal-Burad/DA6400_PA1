...
for seed in args.seed:
    ...
    if args.algorithm == "q_learning":
        ...
        wandb.init(project="cartpole_rl_experiment_q_learning_minimizing_regret", name=file_name + "_seed_" + str(seed))
        ...
        wandb.init(project="cartpole_rl_experiment_sarsa_minimizing_regret", name=file_name + "_seed_" + str(seed))
        # define the q-table
        q_table, bins = Qtable(env.observation_space, env.action_space, args.num_bins)
