...
def train(config=None):
    ...
    with wandb.init(config=config) as run:
        ...
        if config.algorithm == "q_learning":
            ...
            # Learn the q-table
            reward_list = q_learner.learn(config.num_episodes, config.num_steps, config.render)
            ...
            # Learn the q-table
            reward_list = sarsa_learner.learn(config.num_episodes, config.num_steps, config.render)
